...
function buildTable(){
    ...
    if(pageHeadingText == "Tasmania"){
     ...
     '</tr><tr>' +
     '<td>Population Size</td><td>1971-2021</td>' +
     ...
     '<td id="clickables"></td>' +
     '</tr><tr>' +
     '<td>Exposure-to-Risk</td><td>1971-2020</td>' +
     ...
     '</tr><tr>' +
     '<td>Death Rates</td><td>1971-2020</td>' +
     ...
     '</tr><tr>' +
     '<td>Life Tables - Female</td><td>1971-2020</td>' +
     ...
     '</tr><tr>' +
     '<td>Life Tables - Male</td><td>1971-2020</td>' +
     ...
     '</tr><tr>' +
     '<td>Life Tables - Total</td><td>1971-2020</td>' +
     ...
     '</tr><tr>' +
     '<td>Life Expectancy at Birth</td><td>1971-2020</td>' +
     ...
     '</tr><tr>' +
     '<td>Reference file</td><td>2023</td>' +
